						...
						<div className="row d-flex align-items-center justify-content-evenly mt-0 px-10">
								...
								<div className="col-10 col-md-5 text-center">
									<div className="position-relative p-3">
										...
										<a href="https://github.com/Laga4584/portfolio"><img className="img-fluid" alt="github"  src={icon1} width="60px" /></a>
										<a href="https://laga4584.github.io/portfolio/"><img className="img-fluid" alt="pagelink"  src={icon2} width="40px"/></a>
										</div>
									</div>
								</div>
							</div>
